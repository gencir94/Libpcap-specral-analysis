...
int blocco = 0;                     //Block variable

FILE * a;                           //Output file

char salva_ip [1][20];              //save ip address
int salva_mac [6];                  //save mac address

float sequenza_flussi[256];         //save payload sequence
float sequenza_flussi_INVERSE[256]; //save payload sequence inverse
long  sequenza_flussi_TEMPO[256];   //save inter-arrival time sequence

int conto_pacchetti = 0;            //packet counter
int conto_pacchetti_inv = 0;        //packet counter inverse
...
char list_name [30][50] = { "Smart Things","Amazon Echo","Netatmo Welcome",
